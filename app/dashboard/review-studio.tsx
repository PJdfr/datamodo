  ...
  if (live.length === 0) {
    return (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", padding: "80px 20px" }}>
        ...
        <p style={{ fontSize: 15, color: "#57534A", maxWidth: "44ch", margin: 0, lineHeight: 1.55 }}>Every inferred merge, conflict, and low-confidence extraction has been reviewed. New ones appear the moment an agent parses a message.</p>
      </div>
    );
  }
