...
| **Data tab IA** (clarity pass 2026-07-11): Tables · ◍ Explore · Insights — Explore is the one knowledge surface (modes: Walk default · Cards · Map · Concepts · Timeline · Files); rare build actions behind a single "✦ Build ▾" menu | `app/dashboard/control-center.tsx` (`DataView`), `app/dashboard/knowledge-view.tsx` |
